...
export class DataService {
  ...
  private getConfirmedCases(): Observable<String> {
    return this._http.get(`./assets/time_series_covid19_confirmed_global.csv`, {responseType: 'text'});
  }

  private getDeaths(): Observable<String> {
    return this._http.get(`./assets/time_series_covid19_deaths_global.csv`, {responseType: 'text'});
  }

  private getRecovered(): Observable<String> {
    return this._http.get(`./assets/time_series_covid19_recovered_global.csv`, {responseType: 'text'});
  }
